...
A full-featured React application for creating, editing, and managing professional resumes with PDF export functionality.
...
- **PDF Export**: Export your resume as a professional PDF document
...
- **Skills**: Technical skills with proficiency levels, additional skills as bullet points
- **Education**: Institution, degree, location, dates, descriptions
- **Awards & Certifications**: Title, description, dates
...
### Common Issues
1. **PDF Export Not Working**: Ensure popup blockers are disabled
